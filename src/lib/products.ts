...
export const products: Product[] = [
  ...
  },
  {
    ...
    quickBullets: ["Asia, London, New York levels", "Clean labels for fast reading", "Lightweight chart presentation"],
    idealFor: ["Session-based strategy traders", "Breakout and sweep setups", "Clean chart layouts"],
    media: {
